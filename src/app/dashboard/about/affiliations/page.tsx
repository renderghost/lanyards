      ...
      <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4">
        ...
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbItem>
              <BreadcrumbPage>Affiliations</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
        <div className="ml-auto">
          <Button asChild>
            <Link href="/dashboard/about/affiliations/create">
        ...
        {affiliations.length === 0 ? (
          <Card className="mx-auto w-full max-w-2xl flex flex-col items-center justify-center p-8">
            ...
            <CardHeader className="text-center p-0">
              <CardTitle>No affiliations yet</CardTitle>
              <CardDescription>
                ...
                <CardHeader className="pb-3">
                  <div className="flex items-start justify-between gap-4">
                    <div className="space-y-1 flex-1 min-w-0">
                      ...
                      {affiliation.role && (
                        <div className="text-sm text-foreground">{affiliation.role}</div>
                      )}
                    </div>
